...
gramsa = Tracks(CLIENT_ID=None, CLIENT_SECRET=None)

def audio_features_table(id=None):

    audio_features = gramsa.get_audio_features(id=id)
...
def several_audio_features_table(ids=None):

    severeal_audio_features = gramsa.get_several_audio_features(ids=ids)
...
def audio_analysis_table(id=None):

    audio_analysis = gramsa.get_audio_analysis(id=id)
